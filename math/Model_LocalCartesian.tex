...
\begin{tikzpicture}[
  ...
  % --- position vector of the light centre, beta = (beta_1,beta_2) -------
  \draw[inkcol, thick, dashed, -{Latex[length=2.5mm]}] (Origin) -- (SrcPos);
  \node[inkcol, font=\sffamily, anchor=south] at ($(Origin)+(1.88,1.6)$) {$\boldsymbol{\beta}=(\beta_1,\beta_2)$};
  ...
  \fill[inkcol] (SrcPos) circle (0.05);
